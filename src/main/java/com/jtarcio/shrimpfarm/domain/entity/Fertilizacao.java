...
@Entity
@Table(name = "fertilizacoes")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class Fertilizacao {
    ...
    private String produto; // Nome do fertilizante
    ...
    @Column(length = 50)
    private String finalidade; // Ex: "Preparação do viveiro", "Manutenção"
